...
# ==========================================
# AUDIO XULOSA VA ADABIYOTSHUNOS BAHOSI
# ==========================================
...
async def process_audio_summary(message: types.Message, state: FSMContext):
    processing_msg = await message.answer("⏳ <i>Adabiyotshunos seni eshitmoqda...</i>", parse_mode="HTML")
    try:
